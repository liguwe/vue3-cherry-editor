(function () {
    ...
    var internalSet = function (dom, property, value) {
      ...
      if (isSupported$1(dom)) {
        ...
        if (dom.nodeName === 'TR' && dom.getAttribute('data-mce-style')) {
    ...
    var open = function (editor, selections) {
      ...
      document.querySelector('.tox-dialog').classList.add('cherry-table-cell-dialog');
    };
    ...
    var getItems$1 = function (editor, classes, insertNewTable) {
    ...
    var open$2 = function (editor, insertNewTable) {
      ...
      var generalPanel = {
        type: 'grid',
        columns: 2,
        items: getItems$1(editor, classes, insertNewTable)
      };
      ...
      var dialogBody = nonAdvancedForm();
      editor.windowManager.open({
      ...
      document.querySelector('.tox-dialog').classList.add('cherry-table-dialog');
    };
    ...
    var addToolbars = function (editor) {
      var isTable = function (table) {
        if (editor.dom.is(table, 'table') && editor.getBody().contains(table)) {
          var _a = table.getBoundingClientRect(), top_1 = _a.top, bottom = _a.bottom;
          var height = Number(editor.getParam('height')) - 36;
          if (top_1 < 50 && height - bottom < 50) {
            return false;
          }
          return true;
        }
